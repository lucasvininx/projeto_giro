...
export default function DashboardPage() {
  ...
  // Efeito para buscar os dados somente se o usuário estiver autenticado
  useEffect(() => {
  ...
  // Sempre retorna a mesma estrutura, mas renderiza o conteúdo apenas se autenticado e montado
  return (
    <>
